            ...
            >
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className="w-full border-b border-white/20 bg-transparent py-3 font-mono text-lg text-white placeholder:text-[#3f3f46] transition-colors duration-300 focus:border-white focus:outline-none focus:ring-0"
                />
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  ...
                  className="w-full resize-none border-b border-white/20 bg-transparent py-3 font-mono text-lg text-white placeholder:text-[#3f3f46] transition-colors duration-300 focus:border-white focus:outline-none focus:ring-0"
                />
              </div>
