...
export const MANIFESTO = [
  {
    ...
    body: "I believe software should feel like a physical object — with weight, texture and momentum. Every interaction is an opportunity to surprise. I obsess over the milliseconds between intention and response.",
  },
  {
    id: "02",
    title: "The Practice",
    body: "Ten years shipping products across fintech, gaming and generative art. I write the systems and I design the pixels — bridging engineering rigor with an obsession for craft that most teams keep in separate rooms.",
  },
  {
    id: "03",
    title: "The Process",
    body: "Prototype fast, delete faster. I build in the browser, test on real devices, and refine until the friction disappears. Great work is invisible — you only notice its absence.",
  },
];
